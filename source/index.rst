...
本实验文档为哈尔滨工业大学（深圳）《计算机网络》课程实验指导材料。请大家先阅读 :doc:`/lab0/index`，对实验课程有一个整体的认识。关于配置实验，请先阅读 :doc:`/appendix-c/index`，掌握Cisco Packet Tracer的基本使用。关于协议栈编程实验，请先按照 :doc:`/appendix-b/index` 中的说明搭建实验环境，然后再从Eth协议做起。对于有兴趣有余力的同学，建议完成 :doc:`/proplus/index`，若能完成会有意想不到的惊喜！
...
.. code-block:: sh
   ...
   $ git clone https://gitee.com/hitsz-lab/net-lab-2022.git
